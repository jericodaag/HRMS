...
class ConsultationRecordController extends Controller
{
	...
	public function accessRules()
	{
		return array(
			...
			array('allow', // allow authenticated user to perform 'create' and 'update' actions
				'actions'=>array('ListConsultationHistory', 'listConsultationDoc'),
				'users'=>array('doctor'),
			),
			array('allow', // allow authenticated user to perform 'create' and 'update' actions
				'actions'=>array('ListConsultationHistory'),
			...
			array('allow', // allow admin user to perform 'admin' and 'delete' actions
				'actions'=>array('admin','delete', 'listConsultation'),
	...
	public function actionlistConsultationDoc()
    {
        $id = Yii::app()->user->id;
		$listConsultationDoc = ConsultationRecord::model()->findAll(array(
        ...
        $this->render('listConsultationDoc',array(
            'listConsultationDoc'=>$listConsultationDoc,
