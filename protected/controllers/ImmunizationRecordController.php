...
class ImmunizationRecordController extends Controller
{
	...
	public function accessRules()
	{
		return array(
			...
			array('allow', // allow authenticated user to perform 'create' and 'update' actions
				'actions'=>array('create','ImmunizationRecordList'),
				'users'=>array('doctor'),
			),
			array('allow', // allow admin user to perform 'admin' and 'delete' actions
				'actions'=>array('admin','delete', 'ImmunizationRecordList'),
	...
	public function actionImmunizationRecordList()
	{
		$list = ImmunizationRecord::model()->findAll();

		$this->render('ImmunizationRecordList',array(
			'list'=>$list,
		));
	}
